...
export default function MenuDetails() {
  ...
  return (
    <div className="flex flex-col w-full justify-center">
      ...
      <div className="flex w-full justify-center">
        <div className="flex w-full justify-center"> Bewertung: <Button className="hover:text-yellow-500"> &#x2605; </Button> <Button className="hover:text-yellow-500"> &#x2605; </Button> <Button className="hover:text-yellow-500"> &#x2605; </Button> <Button className="hover:text-yellow-500"> &#x2605; </Button> <Button className="hover:text-yellow-500"> &#x2605; </Button> <span className="mr-4"> </span>   War diese Empfehlung hilfreich? <Button className="ml-1 hover:text-yellow-500"> Ja! </Button> <Button className="ml-1 hover:text-yellow-500"> Nein. </Button> </div>
      </div>
